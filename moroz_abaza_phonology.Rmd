...
```{r sibilants-d28, fig.cap="Fricatives by female speaker with non-labialised post-alveolars.", fig.align="center"}
...
```{r experiment-results, fig.cap="Results of experiment. Each dot represents one person colored by result and faceted by gender.", fig.align="center"}
...
T'ap'anta Abaza stress was discussed in my unpublished report from previous expeditions and became a basis for [@arkadiev19].
